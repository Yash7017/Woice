...
public class SceneAsking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scene_asking);
        mVideoView = (VideoView) findViewById(R.id.videoView);
        mypop = findViewById(R.id.pop);
        play = (Button) findViewById(R.id.im1);
        Uri videouri = Uri.parse("https://firebasestorage.googleapis.com/v0/b/woice-95389.appspot.com/o/poochhna1.mp4?alt=media&token=87346860-1c7f-4203-9665-9e0513a3c0e8");
        mVideoView.setVideoURI(videouri);
        mVideoView.requestFocus();
        mVideoView.start();

       /* mVideoView.setVideoPath("https://vc527.pcloud.com/dpZDW1lFBZdQ9GLsZvipp7ZZKUBm37ZQ5ZZf4XZZ9aCLnqFogGY3syWFgGom1fhsAJ9k/poochhna1.mp4");
        mVideoView.start();*/
